...
/* --- Typography --- */
.form-page h1, .form-page h2, .form-page h3, .form-page h4 { font-family: 'Press Start 2P', cursive; margin-bottom: 1rem; color: var(--gbc-screen-text); text-shadow: var(--gbc-glow); word-wrap: break-word; }
.form-page h1 { font-size: 1.4rem; line-height: 1.3; }
.form-page h2 { font-size: 1.1rem; } /* Step headers */
.form-page h3 { font-size: 0.9rem; } /* Result header */
/* --- Logo --- */
...
.form-page #sequenceForm .form-step { display: none; margin-bottom: 1rem; animation: fadeIn 0.5s ease-in-out; }
.form-page #sequenceForm .form-step.active { display: block; }
.form-page #sequenceForm > h2 { display: none; } /* Hide holder H2 */

/* --- Labels & Legends --- */
.form-page label, .form-page legend { display: block; margin-bottom: 0.5rem; color: var(--gbc-screen-text); font-size: 1.1rem; font-family: 'Press Start 2P', cursive; }
.form-page legend { font-size: 0.9rem; margin-bottom: 0.8rem; padding: 0; width: 100%; line-height: 1.4; }
...
.form-page input[type="text"][id$="OtherText"] { margin-top: 5px; } /* Keep specific margin for non-grouped 'other' inputs if any */
.form-page input:focus, .form-page select:focus, .form-page textarea:focus { outline: none; border-color: var(--gbc-screen-text); background: rgba(15, 56, 15, 0.5); }
.form-page select { background-image: url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%239bbc0f'%3e%3cpath d='M7 10l5 5 5-5z'/%3e%3c/svg%3e"); background-repeat: no-repeat; background-position: right 10px center; background-size: 12px; }
...
const FormPage: React.FC = () => {
  // Add logic to handle the multi-step form functionality
  useEffect(() => {
    // Function to handle form navigation
    const setupFormNavigation = () => {
      const form = document.getElementById('sequenceForm') as HTMLFormElement;
      if (!form) return;

      const steps = Array.from(form.querySelectorAll('.form-step'));
      const prevBtn = document.getElementById('prevBtn') as HTMLButtonElement;
      const nextBtn = document.getElementById('nextBtn') as HTMLButtonElement;
      const submitBtn = document.getElementById('finalSubmitBtn') as HTMLButtonElement;
      let currentStep = 0;

      // Function to show the current step
      const showCurrentStep = () => {
        steps.forEach((step, index) => {
          (step as HTMLElement).classList.toggle('active', index === currentStep);
        });
    ...
    const validateCurrentStep = (stepIndex: number): boolean => {
      const currentStepEl = document.querySelectorAll('.form-step')[stepIndex] as HTMLElement;
      ...
      // Check radio groups with required attribute
      const radioGroups = currentStepEl.querySelectorAll('fieldset[required]');
      radioGroups.forEach(fieldset => {
        const radios = fieldset.querySelectorAll('input[type="radio"]');
        const checked = Array.from(radios).some(radio => (radio as HTMLInputElement).checked);
  ...
  return (
    <>
      <Helmet>
        <title>🕹️ REALTY BOT-GBC 🚀 AI Lead Dominator</title>
        <style>{formStyles}</style>
      </Helmet>
      <div className="form-page">
        <div className="gameboy-container">
          <div className="gameboy-shell-top">
            <div className="screen-container">
              ...
              <div className="screen-content">
                ...
                <div id="successMessage" className="hidden">
                  ...
                  <p className="blink">PRESS START TO PLAY AGAIN</p>
                </div>
                ...
                <form id="sequenceForm">
                  ...
                  <div className="form-step active">
                    ...
                    <div className="form-group">
                      <label htmlFor="leadSource">Where do your leads come from?</label>
                      <fieldset>
                        ...
                        <input type="text" id="leadSourceOtherText" placeholder="Please specify" className="hidden" />
                      </fieldset>
                    </div>

                    <div className="form-group">
                      <label htmlFor="leadTemperature">How warm are your leads?</label>
                      <fieldset>
                        <div className="radio-option">
                          <label className="radio-label">
                  ...
                  <div className="form-step">
                    ...
                    <div className="form-group">
                      <label htmlFor="communicationChannel">Preferred contact methods?</label>
                      <fieldset>
                    ...
                    <div className="form-group">
                      <label htmlFor="communicationStyle">What tone works best with your clients?</label>
                      <fieldset>
                        <div className="radio-option">
                          <label className="radio-label">
                  ...
                  <div className="form-step">
                    ...
                    <div className="form-group">
                      <label htmlFor="marketType">What type of market are you in?</label>
                      <fieldset>
                        <div className="radio-option">
                          <label className="radio-label">
                    ...
                    <div className="form-group">
                      <label htmlFor="priceRange">Average price range in your area?</label>
                  ...
                  <div className="form-step">
                    ...
                    <div className="form-group">
                      <label htmlFor="agentStrength">What's your biggest strength as an agent?</label>
                      <fieldset>
                        <div className="radio-option">
                          <label className="radio-label">
                        ...
                        <input type="text" id="strengthOtherText" placeholder="Please specify" className="hidden" />
                      </fieldset>
                    </div>
                  </div>
                  ...
                  <div className="form-step">
                    ...
                    <div className="form-group">
                      <label htmlFor="agencyName">Brokerage/Agency Name</label>
                  ...
                  <div className="form-navigation">
                    <button type="button" id="prevBtn" className="nav-btn prev-btn">← BACK</button>
                    <button type="button" id="nextBtn" className="nav-btn next-btn">NEXT →</button>
                    <button type="submit" id="finalSubmitBtn" className="submit-btn">CREATE MY SEQUENCE</button>
                  </div>
                </form>
              </div>
            </div>
          ...
          <div className="gameboy-shell-bottom">
            <div className="gbc-branding">REALTY-BOY ADVANCE</div>
            ...
            <div className="controls-container">
              ...
              <div className="start-select">
                <div className="pill-button select">SELECT</div>
                <div className="pill-button start">START</div>
              </div>
            </div>
          </div>
        </div>
