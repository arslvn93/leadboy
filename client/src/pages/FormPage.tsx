...
const FormPage: React.FC = () => {
  // Add form navigation functionality when component mounts
  useEffect(() => {
      ...
      if (form) {
        form.addEventListener('submit', (e) => {
          ...
          if (validateCurrentStep(currentStep)) {
            ...
            const formEl = document.getElementById('sequenceForm');
    ...
    // Setup form navigation when component mounts
    setTimeout(setupFormNavigation, 100); // Small delay to ensure DOM is ready
  }, []);
